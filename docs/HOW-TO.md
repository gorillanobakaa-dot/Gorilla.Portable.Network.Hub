...
1. Download `gorilla-portable-network-hub_0.9.4_amd64.deb` from the releases
   page.
...
- **Pass:** `hub --version` prints `hub 0.9.4`.

### On Windows

1. Download `hub-0.9.4-windows-x86_64.zip` and unzip it anywhere.
